...
namespace ReplyInterface
{
    public class ReplyInterface
    {
        ...
        public ReplyInterface(string Username, string userId, string Password, string Screen_name, string proxyAddress, string proxyPort, string proxyUsername, string proxyPassword)
        {
